...
| `CRAWL4AI_CALL_TIMEOUT_MS` | No | Per-call MCP timeout for Crawl4AI tool requests, in milliseconds (default: `150000`). Must exceed the largest crawl budget a request asks for; the default clears the toolkit's own ~135 000 ms worst case. |
